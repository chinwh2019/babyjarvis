...
# %%
# Principle 1: Write clear and specific instructions (4 tactics)
# %%
# Tactic 1: Use delimiters to clearly indicate distinct parts of the input
# Delimiter can be anything like: ```, """, <>, <tag> </tag>, etc.
...
valley fllows from a modest spring; the \ 
...
# We can fix this by instucting the model to work out its own solution first. 
