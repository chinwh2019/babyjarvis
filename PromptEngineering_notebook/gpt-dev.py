...
n = int(0.9 * len(data)) # first 90% of the data will be train set
...
for b in range(batch_size): # batch_dim 
...
# toy example illustrating how matrix multiplication can be sed for a 'weighted aggregation'
...
# %%
x[0, :].mean(), x[0, :].std() # mean std of all features across one batch input
# %%
...
# hyperparameters
batch_size = 16 # how many independent sequences will process parallel?
